...
import aiohttp, datetime, random, json, logging, re, requests, os, sys
...
client = discord.AutoShardedClient(intents=Intents(messages=True, guilds=True))
...
client.run(open('tokens/wn8','r').read())
